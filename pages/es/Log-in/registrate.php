...
<head>
    ...
    <link rel="stylesheet" href="/hatch/src/style/registrate.css">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light navbar-color">
            ...
            <div class="container-fluid nav-bar-brand-container">
                ...
                <a href="/hatch/pages/es/Carrito/carrito.php" title="cart-icon"><i class="fas fa-shopping-cart icon-spacing-cart"></i></i></a>
            </div>
        </nav>
                    ...
                    <div class="login-form bg-light mt-4 p-2">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="row g-3">
                            <div class="title-container">
                                <h4 class="title-signup text-center">¡Unete a Hatch Atelier!</h4>
                                <div class="form-check flex form-check-container">
                                    <br><img src="/hatch/src/style/fontawesome-free-5.15.3-web/svgs/solid/paint-brush.svg" alt="Redes Sociales" style="width:20px; height: 20px;">
                                    <input class="form-check-input" type="checkbox" id="artist">
                                    <label class="form-check-label" for="rememberMe"> Registrarse como
                                        Artista</label><br>
                                    <img src="/hatch/src/style/fontawesome-free-5.15.3-web/svgs/solid/shopping-cart.svg" alt="Redes Sociales" style="width:20px; height: 20px;">
                            ...
                            <div class="form-group">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="email" placeholder="correo electrónico" class="form-control <?php echo (!empty($email_err)); ?>" value="<?php echo $email; ?>">
                            ...
                            <div class="form-group">
                                <div class="col-12">
                                    <label>Usuario</label>
                                    <input type="text" name="username" placeholder="usuario" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
                            ...
                            <div class="col-12 flex-center">
                                <button type="submit" class="btn pink-button" name="register">Registrate</button>
                            </div>
                        </form>
                    </div>
                </div>
