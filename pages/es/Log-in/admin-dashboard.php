            ...
            <div class="container cart-text">
                <div class="row flex-center profile-container">
                    <div class="flex-center flex-column card cart-card col-lg-8 col-md-10 col-sm-12">
                        <h3 class="cart-title showcase-title-text">Administrador</h3>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-6 flex-column flex-space-evenly">
                                    <button type="button" class="btn pink-button profile-submit">Agregar Productos</button>
                                    <button type="button" class="btn pink-button profile-submit">Descargar Reporte</button>
