...
<head>
    ...
    <link rel="stylesheet" href="/hatch/src/style/accesorios.css">
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Item n</h5>
                                <img src="http://placehold.jp/f3d8cd/f0637a/500x500.png?text=En%20Proceso" class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i class="fas fa-heart"></i></span></p>
