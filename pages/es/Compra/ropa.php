<head>
    ...
    <link rel="stylesheet" href="/hatch/src/style/ropa.css">
        ...
        <section>
            ...
            <main>
                <div class="card text-center">
                    <!--seccion de spotlight, call to action-->
                    <div class="card-header format-featured">
                        Descubre nuestra...
                    </div>
                    <div class="card-body format-card-body">
                        <h5 class="card-title text-card-header">¡Hatch Box!</h5>
                        <p class="card-text">Una vez al mes ecibe nuestra cajita curada con artículos únicos de artistas
                            locales</p>
                        <a href="/hatch/pages/es/Compra/suscribite.php" class="btn btn-primary pink-button">¡Suscribete!</a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Vestido Rosa con Conejito</h5>
                                <img src="//live.staticflickr.com/526/31593150176_cae8532227_c.jpg" class="card-img-top"
                                    alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Sueter Conejito</h5>
                                <img src="https://live.staticflickr.com/2812/32944570552_e733d944ee_z.jpg"
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Polo Rosa</h5>
                                <img src="https://live.staticflickr.com/4295/35876648462_25167fe540_c.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles!<span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Special title treatment</h5>
                                <img src="https://live.staticflickr.com/742/32666485424_8a9f99b416_c.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                ...
                <!--termina fila grid de imagenes-->
                <div class="row">
                    <!---inicia grid de imagenes fila-->
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Cardigan y Pullover de Gatito</h5>
                                <img src="https://live.staticflickr.com/2646/32944577222_556234448e_z.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Vestido Prep Rojo</h5>
                                <img src="https://live.staticflickr.com/698/33277385176_1df41ab788.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Conjunto</h5>
                                <img src="//live.staticflickr.com/4369/37206305981_ecee1baa6d_b.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Peplum Rosa Pastel</h5>
                                <img src="//live.staticflickr.com/207/30794617964_5a7d674378_z.jpg" class="card-img-top"
                                    alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                ...
                <!---termina grid de imagenes fila-->
                <div class="row">
                    <!---inicia grid de imagenes fila-->
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Conjunto Coordinato Oso</h5>
                                <img src="//live.staticflickr.com/307/31621458595_4d70d3cc7a_c.jpg" class="card-img-top"
                                    alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Abrigo Pastel</h5>
                                <img src="//live.staticflickr.com/5760/30907162416_cf1712d44e_n.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles</p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                                    Carrito</a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Conjunto Para Niña A</h5>
                                <img src="//live.staticflickr.com/5464/31483709182_d58b22aa1a_c.jpg"
                                    class="card-img-top" alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
                    ...
                    <div class="col-sm-6 grid-card-format">
                        <div class="card">
                            <div class="card-body format-grid-card-body">
                                <h5 class="card-title format-card-title">Cardigan Verde</h5>
                                <img src="//live.staticflickr.com/681/32971791062_2f3db43840_z.jpg" class="card-img-top"
                                    alt="">
                                <p class="card-text">Haz Click para mas detalles! <span><i
                                            class="fas fa-heart"></i></span></p>
                                <a href="/hatch/pages/es/Carrito/carrito.php" class="btn btn-primary pink-button">Agregar al
